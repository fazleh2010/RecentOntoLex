...
public class DBpediaMain {
    ...
    private void parseNgrams() throws IOException, Exception {
    ...
    private void processEntities() throws IOException, Exception {
        List<String> list = new ArrayList<String>();
    ...
    private void parseOutput() throws IOException, Exception {
        Map<String, List<String>> nGramClassFiles = new HashMap<String, List<String>>();
        List<Ngram> ngrams = new ArrayList<Ngram>();
