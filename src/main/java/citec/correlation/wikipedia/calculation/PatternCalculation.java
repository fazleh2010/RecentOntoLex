...
import static citec.correlation.wikipedia.results.ObjectWordResults.WORD_CALCULATION;
...
public class PatternCalculation implements PatternThresold{
    ...
    private PosAnalyzer analyzer = new PosAnalyzer(POS_TAGGER_TEXT, 5);
    ...
    private Map<String, List<WordObjectResults>> patternEntities = new TreeMap<String, List<WordObjectResults>>();
    ...
    private List<DBpediaEntityPattern> getAllElements(String inputDir, String inputFile, String dbo_ClassName) throws Exception {
        ...
        Tables tables = new Tables( inputDir);
    ...
    private String entityResultToString(ObjectWordResults entities, String type) {
      
        String objectString = null, propertyString = "property=", idString = "id=", wordString = null;

        if (type.contains(ObjectWordResults.PATTERN_CALCULATION)) {
            wordString = "pattern=";
    ...
    public Map<String, List<WordObjectResults>> getPatternEntities() {
