...
public class FormatAndMatch {
    ...
    public static boolean isValidForObject(String str) {
        ...
        if (isNoLetters(str)) {
            return false;
        } else if (str.equals("true") || str.equals("false") || str.equals("yes") || str.equals("no")
                || str.equals("cdt") || str.equals("s") || str.equals("t")
                || str.equals("y") || str.equals("n") || str.equals("w") || str.equals("e") || str.equals("a") || str.equals("b") || str.equals("d")) {
            return false;
        }
     ...
     public static boolean isNoLetters(String str) {
